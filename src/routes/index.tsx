...
function App() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <p className="hero-description text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto mb-12 leading-relaxed">
            Crafting beautiful digital experiences with modern web technologies. Specialized in
            React, TypeScript, and creative animations.
          </p>
      ...
      {/* Projects Section */}
      <section ref={projectsRef} className="projects-section py-24 px-6 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="flex gap-4">
                  ...
                  <button
                    type="button"
                    className="flex-1 px-4 py-2 bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-sm font-medium rounded-lg transition-colors"
                  >
      ...
      <footer className="py-12 px-6 border-t border-slate-800">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-slate-500">
            Built with <span className="text-red-500">♥</span> using TanStack Start, TailwindCSS,
            and GSAP
          </p>
        </div>
      </footer>
